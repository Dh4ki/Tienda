...
export class ProductoService {
  ...
  actualizar_producto_variedades_admin(token:any,id:any, data:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
      return this._http.put(this.url+'actualizar_producto_variedades_admin/'+data,id,{headers:headers});
  }

  agregar_imagen_galeria_admin(id:any,token:any,data:any):Observable<any>{
    let headers = new HttpHeaders({'Authorization':token});
  ...
  eliminar_imagen_galeria_admin(id:any, token:any, data:any):Observable<any>{
    let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
      return this._http.put(this.url+'eliminar_imagen_galeria_admin/'+data,id,{headers:headers});
  }
